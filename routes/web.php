...
Route::group(['middleware' => ['check_mobile_app', 'share', 'check_maintenance']], function () {
    Route::get('requests/orginatzation_subscription', [PortalController::class, 'subscribe'])->name('subscribe');
    Route::post('orginatzation_subscription', [PortalController::class, 'subscribe_post'])->name('subscribe_post');
});
