...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web',  'admin_locale']], function () use ($prefix) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'portals'], function () {
            ...
            Route::get('{id}/view', [PortalController::class, 'portal_create'])->name('portal.create');

            //portal update
            Route::match(['PUT'],'{portal}', [PortalController::class, 'portal_basic_update'])->name('portal.basic.update');
            Route::put('{portal}/socail',[PortalController::class,'portal_social_update'])->name('portal.socail.update');
            Route::put('{portal}/interface',[PortalController::class,'portal_interface_update'])->name('portal.interface.update');
            Route::put('{portal}/password',[PortalController::class,'portal_password_update'])->name('portal.password.update');
            Route::put('{portal}/features',[PortalController::class,'portal_features_update'])->name('portal.features.update');
            Route::put('{portal}/accept',[PortalController::class,'portal_accept'])->name('portal.accept');

            Route::delete('{id}', [PortalController::class, 'subscribe_delete'])->name('subscribe.destroy');
            Route::put('portals/{id}', [PortalController::class, 'active_toggle'])->name('portal.active.toggle');

            //portal meetings
            Route::get('meetings', [PortalController::class, 'meetings'])->name('meetings.index');
            Route::get('meetings/create', [PortalController::class, 'meetings_create'])->name('meetings.create');
            Route::post('meetings/create', [PortalController::class, 'meetings_store'])->name('meetings.store');

            //meetings
            Route::post('meetings/{id}/active', [PortalController::class, 'meetings_active_toggle'])->name('meetings.active.toggle');
            Route::post('meetings/{id}/delete', [PortalController::class, 'meetings_delete'])->name('meetings.delete');
            
            //departments
            Route::get('departments',[PortalController::class,'departments'])->name('departments.index');
            Route::get('departments/create',[PortalController::class,'departments_create'])->name('departments.create');
            Route::post('departments/create',[PortalController::class,'departments_store'])->name('departments.store');
        ...
        Route::get('/abous_us_export', 'DashboardController@getAboutUsData');
        ...
        Route::group(['prefix' => 'students'], function () {
            ...
            Route::get('/all', 'UserController@students');
        ...
        Route::get('/bundleStudents/{bundleStudent}/delete', 'UserController@deleteDirectRegister');
        ...
        Route::group(['prefix' => 'classes'], function () {
            ...
            Route::put('/{class}/update', 'StudyClassController@update');
        ...
        Route::group(['prefix' => 'requirements'], function () {
            ...
            Route::get('/{id}/approve', 'RequirementController@approve')->middleware('can:admin_requirements_approve')->name('requirment.approve');
            Route::get('/{id}/reject', 'RequirementController@reject')->middleware('can:admin_requirements_reject')->name('requirment.reject');
        ...
        Route::group(['prefix' => 'financial'], function () {
            ...
            Route::get('/charge', 'SaleController@getAccountsForCharge');
            Route::post('account/{user}/charge', 'SaleController@chargeAccount');
...
Route::group(['middleware' => ['check_mobile_app', 'share', 'check_maintenance']], function () {
    Route::get('/{company_name}', [PortalController::class, 'portal_login'])->name('portal.login');
});
