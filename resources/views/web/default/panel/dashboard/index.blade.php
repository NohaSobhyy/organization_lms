...
@section('content')
    <section class="dashboard">
        ...
        <div class="row p-20">
            <div class="col-12  mt-35 @if ($authUser->isUser()) col-lg-5 @endif">
                                ...
                                <svg width="63" viewBox="0 0 63 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        <clipPath id="clip0_10_1564">
                                            <rect width="50" height="41.6667" fill="white"
                                                transform="translate(0 8.33334)" />
                                        </clipPath>
                                    </defs>
                                </svg>
...
{{--
                            <div
                                ...
                                @if ($can_drawable)
                                    ...
                                    <span
                                        class="font-16 font-weight-bold text-secondary">{{ handlePrice($drawable) }}</span>
                                @else
                ...
                <div class="col-12 col-lg-3">
                    <div
                        ...
                        <div class="d-flex flex-column pt-35" style="align-items: center;">
                            ...
                            <span class="font-16 text-gray font-weight-500 text-center pb-10">
                                مايكروسوفت
                            </span>
                            <a target="_blank" rel="noopener noreferrer" class="btn btn-primary mt-10" style=""
                                href="https://go.microsoft.com/fwlink/?linkid=2187217&amp;clcid=0x409&amp;culture=en-us&amp;country=us/">
                                اضغط هنا لتحميل برنامج مايكروسوفت تيمز
                            </a>

                            <a target="_blank" rel="noopener noreferrer" class="btn btn-primary mt-10" style=""
                                href="https://portal.office.com/">
                                اضغط هنا لتسجيل دخول علي office 365
