            ...
            <div class="">
                ...
                <form class="modal-body" method="post" action="/panel/services/{{ $service->id }}/bundleTransform">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('from_bundle_id')  is-invalid @enderror" name="from_bundle_id"
                            id="from_bundle_id">
                    ...
                    <div class="form-group">
                        ...
                        <select id="bundleSelect" class="form-control @error('to_bundle_id')  is-invalid @enderror"
                            name="to_bundle_id" required onchange="handleBundleChange(event);CertificateSectionToggle();">
                    ...
                    <div class="form-group d-none">
                        <label class="form-label">حدد التخصص المزدوج الذي تريده<span class="text-danger">*</span></label>
