...
@section('content')
    ...
    <div class="p-md-4 m-md-3">
        <div class="col-7 col-md-7 p-0 mb-5 mt-3 mt-md-auto">
            ...
            <img src="images/{{ $portal['logo'] ?? '' }}" alt="logo" width="100%">
            @if (!$portal['activated'])
                <div class="alert alert-warning mt-5 " style="font-weight:bold;">
                    <p>الحساب معطل </p>
                    <p>يرجى التواصل مع الدعم لحل المشكله </p>
                </div>
            @endif
        </div>
        @if ($portal['activated'])
            ...
            <form method="POST" action="" class="needs-validation" novalidate="">
                ...
                <div class="text-left forgetpw d-flex justify-content-around text-center text-secondary">
                    ...
                    <a href="https://anasacademy.uk/certificate/certificate-check.php" target="_blank">التحقق من
                        الشهادات</a>
                </div>
                ...
                <div class="socail-links">
                    <div class="row text-center align-items-center">
                        @if(!empty($portal->facebook))
                        <div class="col-3">
                            <a href="{{$portal->facebook}}">
                                <img target="_blank" src="{{ asset('portal/facebook.png') }}" style="width: 40%;">
                            </a>
                        </div>
                        @endif

                        @if(!empty($portal->linkedin))
                        <div class="col-3">
                            <a  href="{{$portal->linkedin}}">
                            <img src="{{ asset('portal/linkedin.png') }}" style="width: 40%;">
                            </a>
                        </div>
                        @endif

                        @if(!empty($portal->twitter))
                        <div class="col-3">
                            <a  href="{{$portal->twitter}}">
                                <img src="{{ asset('portal/twitter.png') }}" style="width: 40%;">
                            </a>
                        </div>
                        @endif

                        @if(!empty($portal->other_link))
                        <div class="col-3">
                            <a  href="{{$portal->other_link}}">
                                <img src="{{ asset('portal/link.png') }}" style="width: 40%;">
                            </a>
                        </div>
                        @endif
