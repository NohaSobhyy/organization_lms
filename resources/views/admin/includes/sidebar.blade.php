<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/portals*', false)) ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fas fa-graduation-cap"></i>
                    <span>ادارة المنافذ</span>
                </a>
                <ul class="dropdown-menu">
                    <li class="{{ request()->is(getAdminPanelUrl('/portals/requests', false)) ? 'active' : '' }}">
                        <a class="nav-link @if (!empty($sidebarBeeps['requirements']) and $sidebarBeeps['requirements']) beep beep-sidebar @endif"
                            href="{{ getAdminPanelUrl() }}/portals/requests">الطلبات</a>
                    </li>

                    <li class="{{ request()->is(getAdminPanelUrl('/portals', false)) ? 'active' : '' }}">
                        <a class="nav-link @if (!empty($sidebarBeeps['requirements']) and $sidebarBeeps['requirements']) beep beep-sidebar @endif"
                            href="{{ getAdminPanelUrl() }}/portals">المنافذ</a>
                    </li>

                    <li class="{{ request()->is(getAdminPanelUrl('/portals/meetings', false)) ? 'active' : '' }}">
                        <a class="nav-link @if (!empty($sidebarBeeps['requirements']) and $sidebarBeeps['requirements']) beep beep-sidebar @endif"
                            href="{{ getAdminPanelUrl() }}/portals/meetings">مواعيد الاجتماعات</a>
                    </li>
                    
                    <li class="{{ request()->is(getAdminPanelUrl('/portals/departments', false)) ? 'active' : '' }}">
                        <a class="nav-link @if (!empty($sidebarBeeps['requirements']) and $sidebarBeeps['requirements']) beep beep-sidebar @endif"
                            href="{{ getAdminPanelUrl() }}/portals/departments">الاقسام</a>
                    </li>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/students/*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ request()->is(getAdminPanelUrl('/students/all', false)) ? 'active' : '' }}">
                        <a class="nav-link @if (!empty($sidebarBeeps['all']) and $sidebarBeeps['all']) beep beep-sidebar @endif"
                            href="{{ getAdminPanelUrl() }}/students/all/">كل الطلاب</a>
                    </li>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/courses/list', false)) ? 'active' : '' }}">
                        <a href="{{ getAdminPanelUrl() }}/courses/list"
                            class="nav-link @if (!empty($sidebarBeeps['list']) and $sidebarBeeps['list']) beep beep-sidebar @endif">{{
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/courses', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/courses/enrollers', false)) ? 'active' : '' }}">
            ...
            <li
                class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/bundle_transforms*', false)) ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fas fa-graduation-cap"></i>
                    <span>التحويلات</span>
                </a>
                <ul class="dropdown-menu">
                    ...
                    <li
                        class="{{ request()->is(getAdminPanelUrl('/financial/bundle_transforms', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/bundle_transforms">{{ ' قائمة
                            بالطلبات' }}</a>
                    </li>
                    @endcan
                </ul>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li
                        ...
                        <a class="nav-link @if (!empty($sidebarBeeps['webinars']) and $sidebarBeeps['webinars']) beep beep-sidebar @endif"
                            href="{{ getAdminPanelUrl() }}/webinars?type=webinar">{{ trans('admin/main.live_classes')
                            }}</a>
                    </li>
                    ...
                    <li
                        ...
                        <a class="nav-link @if (!empty($sidebarBeeps['textLessons']) and $sidebarBeeps['textLessons']) beep beep-sidebar @endif"
                            href="{{ getAdminPanelUrl() }}/webinars?type=text_lesson">{{
                            trans('admin/main.text_courses') }}</a>
                    </li>
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/webinars/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/webinars/create">{{ trans('admin/main.new')
                            }}</a>
                    </li>
                    @endcan()
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/agora_history', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/agora_history">{{
                            trans('update.agora_history') }}</a>
                    </li>
                    @endcan
            ...
            <li class="nav-item dropdown
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ (request()->is(getAdminPanelUrl('/bundles', false)) and request()->get('type', 'program') == 'program')
                                    ? 'active'
                                    : '' }}">
                    ...
                    <li class="{{ (request()->is(getAdminPanelUrl('/bundles/create', false)) and
                                request()->get('type', 'program') == 'program')
                                    ? 'active'
                                    : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/bundles/create?type=program">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan()
                </ul>
            </li>
            ...
            <li class="nav-item dropdown
                ...
                <ul class="dropdown-menu">
                    @can('admin_bundles_list')
                    <li class="{{ (request()->is(getAdminPanelUrl('/bundles', false)) and request()->get('type') == 'bridging')
                                    ? 'active'
                                    : '' }}">
                    ...
                    @can('admin_bundles_create')
                    <li class="{{ (request()->is(getAdminPanelUrl('/bundles/create', false)) and request()->get('type') == 'bridging')
                                    ? 'active'
                                    : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/bundles/create?type=bridging">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan()
                </ul>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/classes', false)) ? 'active' : '' }}">
                        <a href="{{ getAdminPanelUrl() }}/classes"
                            class="nav-link @if (!empty($sidebarBeeps['classes']) and $sidebarBeeps['classes']) beep beep-sidebar @endif">{{
                            trans('admin/main.lists') }}</a>
                    </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/upcoming_courses', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl('/upcoming_courses') }}">{{
                            trans('admin/main.lists') }}</a>
                    </li>
                    @endcan()
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/upcoming_courses/new', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl('/upcoming_courses/new') }}">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan()
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/certificates', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/certificates">{{
                            trans('update.quizzes_related') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/certificates/course-competition">{{
                            trans('update.course_certificates') }}</a>
                    </li>
                    @endcan

                    @can('admin_certificate_template_list')
                    <li class="{{ request()->is(getAdminPanelUrl('/certificates/templates', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/certificates/templates">{{
                            trans('admin/main.certificates_templates') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/certificates/templates/new">{{
                            trans('admin/main.new_template') }}</a>
                    </li>
                    @endcan
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/course-noticeboards', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/course-noticeboards">{{
                            trans('admin/main.lists') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/course-noticeboards/send">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/enrollments*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/enrollments/history', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/enrollments/history">{{
                            trans('public.history') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/enrollments/add-student-to-class">{{
                            trans('update.add_student_to_a_class') }}</a>
                    </li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/categories*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/categories', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/categories">{{ trans('admin/main.lists')
                            }}</a>
                    </li>
                    @endcan()
                    @can('admin_categories_create')
                    <li class="{{ request()->is(getAdminPanelUrl('/categories/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/categories/create">{{ trans('admin/main.new')
                            }}</a>
                    </li>
                    @endcan()
                    @can('admin_trending_categories')
                    <li class="{{ request()->is(getAdminPanelUrl('/categories/trends', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/categories/trends">{{
                            trans('admin/main.trends') }}</a>
                    </li>
                    @endcan()
                </ul>
            </li>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/filters*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/filters/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/filters/create">{{ trans('admin/main.new')
                            }}</a>
                    </li>
                    @endcan()
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/instructors', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/instructors">{{ trans('home.instructors')
                            }}</a>
                    </li>
                    @endcan()
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/organizations', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/organizations">{{
                            trans('admin/main.organizations') }}</a>
                    </li>
                    @endcan()

                    @can('admin_users_create')
                    <li class="{{ request()->is(getAdminPanelUrl('/users/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/users/create">{{ trans('admin/main.new')
                            }}</a>
                    </li>
                    @endcan()
                </ul>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/roles*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/roles', false)) ? 'active' : '' }}">
                        <a class="nav-link active" href="{{ getAdminPanelUrl() }}/roles">{{ trans('admin/main.lists')
                            }}</a>
                    </li>
                    @endcan()
                    @can('admin_roles_create')
                    <li class="{{ request()->is(getAdminPanelUrl('/roles/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/roles/create">{{ trans('admin/main.new')
                            }}</a>
                    </li>
                    @endcan()
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/users/groups', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/users/groups">{{ trans('admin/main.lists')
                            }}</a>
                    </li>
                    @endcan
                    @can('admin_group_create')
                    <li class="{{ request()->is(getAdminPanelUrl('/users/groups/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/users/groups/create">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/forums*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/forums/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/forums/create">{{ trans('admin/main.new')
                            }}</a>
                    </li>
                    @endcan()
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/featured-topics', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/featured-topics">{{ trans('admin/main.lists')
                            }}</a>
                    </li>
                    @endcan()
                    @can('admin_featured_topics_create')
                    <li class="{{ request()->is(getAdminPanelUrl('/featured-topics/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/featured-topics/create">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan()
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/recommended-topics', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/recommended-topics">{{
                            trans('admin/main.lists') }}</a>
                    </li>
                    @endcan()
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/recommended-topics/create">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan()
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/supports/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/supports/create">{{
                            trans('admin/main.new_ticket') }}</a>
                    </li>
                    @endcan

                    @can('admin_support_departments')
                    <li class="{{ request()->is(getAdminPanelUrl('/supports/departments', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/supports/departments">{{
                            trans('admin/main.departments') }}</a>
                    </li>
                    @endcan
                </ul>
            </li>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/comments/webinars', false)) ? 'active' : '' }}">
                        <a class="nav-link @if (!empty($sidebarBeeps['classesComments']) and $sidebarBeeps['classesComments']) beep beep-sidebar @endif"
                            href="{{ getAdminPanelUrl() }}/comments/webinars">{{ trans('admin/main.classes_comments')
                            }}</a>
                    </li>
                    @endcan
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/reports/webinars', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/reports/webinars">{{ trans('panel.classes')
                            }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/comments/webinars/reports">{{
                            trans('admin/main.classes_comments_reports') }}</a>
                    </li>
                    @endcan

                    @can('admin_blog_comments_reports')
                    <li class="{{ request()->is(getAdminPanelUrl('/comments/blog/reports', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/comments/blog/reports">{{
                            trans('admin/main.blog_comments_reports') }}</a>
                    </li>
                    @endcan

                    @can('admin_report_reasons')
                    <li class="{{ request()->is(getAdminPanelUrl('/reports/reasons', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/reports/reasons">{{
                            trans('admin/main.report_reasons') }}</a>
                    </li>
                    @endcan()

                    @can('admin_forum_topic_post_reports')
                    <li class="{{ request()->is(getAdminPanelUrl('/reports/forum-topics', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/reports/forum-topics">{{
                            trans('update.forum_topics') }}</a>
                    </li>
                    @endcan()
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/noticeboards', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/noticeboards">{{ trans('admin/main.lists')
                            }}</a>
                    </li>
                    @endcan
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/noticeboards/send', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/noticeboards/send">{{ trans('admin/main.new')
                            }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/notifications', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/notifications">{{ trans('public.history')
                            }}</a>
                    </li>
                    @endcan
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/notifications/posted', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/notifications/posted">{{
                            trans('admin/main.posted') }}</a>
                    </li>
                    @endcan

                    @can('admin_notifications_send')
                    <li class="{{ request()->is(getAdminPanelUrl('/notifications/send', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/notifications/send">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/notifications/templates">{{
                            trans('admin/main.templates') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/notifications/templates/create">{{
                            trans('admin/main.new_template') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/store/products/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/products/create">{{
                            trans('update.new_product') }}</a>
                    </li>
                    @endcan()

                    @can('admin_store_products')
                    <li class="{{ request()->is(getAdminPanelUrl('/store/products', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/products">{{ trans('update.products')
                            }}</a>
                    </li>
                    @endcan()
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/in-house-products">{{
                            trans('update.in-house-products') }}</a>
                    </li>
                    @endcan()

                    @can('admin_store_products_orders')
                    <li class="{{ request()->is(getAdminPanelUrl('/store/orders', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/orders">{{ trans('update.orders')
                            }}</a>
                    </li>
                    @endcan()
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/store/in-house-orders', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/in-house-orders">{{
                            trans('update.in-house-orders') }}</a>
                    </li>
                    @endcan()

                    @can('admin_store_products_sellers')
                    <li class="{{ request()->is(getAdminPanelUrl('/store/sellers', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/sellers">{{ trans('update.sellers')
                            }}</a>
                    </li>
                    @endcan()
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/store/categories', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/categories">{{
                            trans('admin/main.categories') }}</a>
                    </li>
                    @endcan()

                    @can('admin_store_filters_list')
                    <li class="{{ request()->is(getAdminPanelUrl('/store/filters', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/filters">{{ trans('update.filters')
                            }}</a>
                    </li>
                    @endcan()
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/store/specifications', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/specifications">{{
                            trans('update.specifications') }}</a>
                    </li>
                    @endcan()

                    @can('admin_store_discounts')
                    <li class="{{ request()->is(getAdminPanelUrl('/store/discounts', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/discounts">{{
                            trans('admin/main.discounts') }}</a>
                    </li>
                    @endcan()

                    @can('admin_store_products_comments')
                    <li class="{{ request()->is(getAdminPanelUrl('/comments/products*', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/comments/products">{{
                            trans('admin/main.comments') }}</a>
                    </li>
                    @endcan()
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/comments/products/reports">{{
                            trans('admin/main.comments_reports') }}</a>
                    </li>
                    @endcan

                    @can('admin_store_products_reviews')
                    <li class="{{ request()->is(getAdminPanelUrl('/store/reviews', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/reviews">{{ trans('admin/main.reviews')
                            }}</a>
                    </li>
                    @endcan
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/store/settings', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/store/settings">{{
                            trans('admin/main.settings') }}</a>
                    </li>
                    @endcan
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/blog/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/blog/create">{{ trans('admin/main.new_post')
                            }}</a>
                    </li>
                    @endcan
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/blog/categories', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/blog/categories">{{
                            trans('admin/main.categories') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/pages*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/pages/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/pages/create">{{ trans('admin/main.new_page')
                            }}</a>
                    </li>
                    @endcan()
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/additional_page/404', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/additional_page/404">{{
                            trans('admin/main.error_404') }}</a>
                    </li>
                    @endcan()
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/additional_page/contact_us">{{
                            trans('admin/main.contact_us') }}</a>
                    </li>
                    @endcan()

                    @can('admin_additional_pages_footer')
                    <li class="{{ request()->is(getAdminPanelUrl('/additional_page/footer', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/additional_page/footer">{{
                            trans('admin/main.footer') }}</a>
                    </li>
                    @endcan()
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/additional_page/navbar_links">{{
                            trans('admin/main.top_navbar') }}</a>
                    </li>
                    @endcan()
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/testimonials', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/testimonials">{{ trans('admin/main.lists')
                            }}</a>
                    </li>
                    @endcan()
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/testimonials/create', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/testimonials/create">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan()
                </ul>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/regions*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/regions/countries', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/regions/countries">{{
                            trans('update.countries') }}</a>
                    </li>
                    @endcan()

                    @can('admin_regions_provinces')
                    <li class="{{ request()->is(getAdminPanelUrl('/regions/provinces', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/regions/provinces">{{
                            trans('update.provinces') }}</a>
                    </li>
                    @endcan()

                    @can('admin_regions_cities')
                    <li class="{{ request()->is(getAdminPanelUrl('/regions/cities', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/regions/cities">{{ trans('update.cities')
                            }}</a>
                    </li>
                    @endcan()
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/regions/districts', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/regions/districts">{{
                            trans('update.districts') }}</a>
                    </li>
                    @endcan()
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/financial/documents', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/documents">{{
                            trans('admin/main.list') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/documents/new">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            @can('admin_charge_account')
                <li class="{{ request()->is(getAdminPanelUrl('/financial/charge*', false)) ? 'active' : '' }}">
                    <a href="{{ getAdminPanelUrl() }}/financial/charge" class="nav-link">
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/financial/subscribes', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/subscribes">{{
                            trans('admin/main.packages') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/subscribes/new">{{
                            trans('admin/main.new_package') }}</a>
                    </li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/rewards*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/rewards/items', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/rewards/items">{{ trans('update.conditions')
                            }}</a>
                    </li>
                    @endcan
                    @can('admin_rewards_settings')
                    <li class="{{ request()->is(getAdminPanelUrl('/rewards/settings', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/rewards/settings">{{
                            trans('admin/main.settings') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/registration-packages">{{
                            trans('admin/main.packages') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/registration-packages/new">{{
                            trans('admin/main.new_package') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/registration-packages/reports">{{
                            trans('admin/main.reports') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/registration-packages/settings">{{
                            trans('admin/main.settings') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl('/financial/installments/create') }}">{{
                            trans('update.new_plan') }}</a>
                    </li>
                    @endcan

                    @can('admin_installments_list')
                    <li class="{{ request()->is(getAdminPanelUrl('/financial/installments', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl('/financial/installments') }}">{{
                            trans('update.plans') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl('/financial/installments/purchases') }}">{{
                            trans('update.purchases') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl('/financial/installments/overdue') }}">{{
                            trans('update.overdue') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl('/financial/installments/overdue_history') }}">{{
                            trans('update.overdue_history') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link"
                            href="{{ getAdminPanelUrl('/financial/installments/verification_requests') }}">{{
                            trans('update.verification_requests') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl('/financial/installments/verified_users') }}">{{
                            trans('update.verified_users') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl('/financial/installments/settings') }}">{{
                            trans('admin/main.settings') }}</a>
                    </li>
                    @endcan
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/financial/discounts', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/discounts">{{
                            trans('admin/main.lists') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/discounts/new">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/special_offers">{{
                            trans('admin/main.lists') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/special_offers/new">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/webinars/features', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/webinars/features">{{
                            trans('admin/main.lists') }}</a>
                    </li>
                    @endcan()
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/webinars/features/create">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/cashback*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/cashback/rules/new', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl('/cashback/rules/new') }}">{{
                            trans('update.new_rule') }}</a>
                    </li>
                    @endcan

                    @can('admin_cashback_rules')
                    <li class="{{ request()->is(getAdminPanelUrl('/cashback/rules', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl('/cashback/rules') }}">{{ trans('update.rules')
                            }}</a>
                    </li>
                    @endcan
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/cashback/transactions', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl('/cashback/transactions') }}">{{
                            trans('update.transactions') }}</a>
                    </li>
                    @endcan

                    @can('admin_cashback_history')
                    <li class="{{ request()->is(getAdminPanelUrl('/cashback/history', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl('/cashback/history') }}">{{
                            trans('update.history') }}</a>
                    </li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/gifts*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/gifts/settings', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl('/gifts/settings') }}">{{
                            trans('admin/main.settings') }}</a>
                    </li>
                    @endcan
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/financial/promotions', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/promotions">{{
                            trans('admin/main.plans') }}</a>
                    </li>
                    @endcan
                    @can('admin_promotion_list')
                    <li
                        class="{{ request()->is(getAdminPanelUrl('/financial/promotions/sales', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/promotions/sales">{{
                            trans('admin/main.promotion_sales') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/promotions/new">{{
                            trans('admin/main.new_plan') }}</a>
                    </li>
                    @endcan
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/advertising/banners', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/advertising/banners">{{
                            trans('admin/main.list') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/advertising/banners/new">{{
                            trans('admin/main.new') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/newsletters*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/newsletters', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/newsletters">{{ trans('admin/main.list')
                            }}</a>
                    </li>
                    @endcan
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/newsletters/send', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/newsletters/send">{{ trans('admin/main.send')
                            }}</a>
                    </li>
                    @endcan
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/newsletters/history', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/newsletters/history">{{
                            trans('public.history') }}</a>
                    </li>
                    @endcan
                </ul>
            ...
            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/referrals*', false)) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/referrals/history', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/referrals/history">{{ trans('public.history')
                            }}</a>
                    </li>
                    @endcan
                    ...
                    <li class="{{ request()->is(getAdminPanelUrl('/referrals/users', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/referrals/users">{{
                            trans('admin/main.affiliate_users') }}</a>
                    </li>
                    @endcan
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl('/registration_bonus/history') }}">{{
                            trans('update.bonus_history') }}</a>
                    </li>
                    @endcan
                    ...
                    <li
                        ...
                        <a class="nav-link" href="{{ getAdminPanelUrl('/registration_bonus/settings') }}">{{
                            trans('admin/main.settings') }}</a>
                    </li>
                    @endcan
