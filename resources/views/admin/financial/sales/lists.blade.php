                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="type" data-plugin-selectTwo class="form-control populate">
                                        ...
                                        <option value="charge" @if (request()->get('type') == 'charge') selected @endif>
                                            شحن حساب
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="bundle_title" class="form-control"
                                        value="{{ request()->get('bundle_title') }}">
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th>{{ trans('admin/main.paid_total_amount') }}</th>
                                        <th>{{ trans('admin/main.paid_amount') }}</th>
                                        <th>{{ trans('admin/main.discount') }}</th>
                                        <th>{{ trans('admin/main.charge_amount') }}</th>
                                    ...
                                    @foreach ($sales as $index => $sale)
                                        <tr>
                                           ...
                                           --}}
 <td>
                                            {{ handlePrice($sale->total_amount + ($sale->discount ?? 0) + ($sale->order->charge_amount ?? 0)) }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span class="">{{ handlePrice($sale->discount ?? 0) }}
                                                    {{ $sale->discount > 0 ? '(' . $sale?->order?->orderItems?->first()?->getDiscount?->percent . '%)' ?? '' : '' }}
                                                </span>
                                            </td>
                                            <td>
                                                <span class="">{{ handlePrice($sale->order->charge_amount ?? 0) }}
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    @else
                                                        ...
                                                        @if (!empty($sale->transform_bundle_id) && $sale->type != 'transform_bundle')
                                                            <div class="text-center font-weight-500 text-success">محول
                                                            </div>
                                                        @endif
                                                        <div class="text-primary text-small font-600-bold">ID :
                                                            {{ $sale->item_id }}</div>
                                            ...
                                            <td>
                                                @if (!empty($sale->refund_at))
                                                    ...
                                                    @include('admin.includes.message_button', [
                                                        ...
                                                        'btnText' =>
                                                            '<span class="ml-2">' . ' سبب الإستيرداد</span>',
